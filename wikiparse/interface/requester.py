...
class Requester:
  async def get(self, url: str, *args, params: Dict[str, Any], **kwargs) -> Awaitable[Response]:
    """Perform a `GET` request to the given `url`. Underlying API should support `params`."""
    raise NotImplementedError()
  
  async def post(self, url: str, *args, params: Dict[str, Any], **kwargs) -> Awaitable[Response]:
    """Perform a `POST` request to the given `url`. Underlying API should support `params`."""
    raise NotImplementedError()
  
  async def put(self, url: str, *args, params: Dict[str, Any], **kwargs) -> Awaitable[Response]:
    """Perform a `PUT` request to the given `url`. Underlying API should support `params`."""
    raise NotImplementedError()
  
  async def update(self, url: str, *args, params: Dict[str, Any], **kwargs) -> Awaitable[Response]:
    """Synonymous for `Requester.put`."""
    raise NotImplementedError()
  
  async def delete(self, url: str, *args, params: Dict[str, Any], **kwargs) -> Awaitable[Response]:
